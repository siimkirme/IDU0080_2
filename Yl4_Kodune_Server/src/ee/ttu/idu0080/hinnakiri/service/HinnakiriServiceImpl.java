...
public class HinnakiriServiceImpl implements HinnakiriService {
	...
	throws HinnakiriNumberFormatException, HinnakiriNegNumberFormatException, HinnakiriNullNumberFormatException, HinnakiriDecimalNumberFormatException {
		...
		String maxPrice = Double.toString(Math.abs(maximumPrice));
		if (maxPrice.length() - maxPrice.indexOf('.') - 1 > 2)
